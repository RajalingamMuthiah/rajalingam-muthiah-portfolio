...
const PROJECTS = [
  {
    id: 1,
    name: "Real-Time Hand Tracking** – AI-Powered Virtual warch Overlay",
...
`,
    link: "https://github.com/RajalingamMuthiah/Real-Time-Hand-Tracking-Virtual-Watch-Overlay.git",
    images: [
  ...
  {
    id: 2,
    name: "Digital Animal care & Emergency Response Platform",
    ...
    link: "https://github.com/RajalingamMuthiah",
    images: [
